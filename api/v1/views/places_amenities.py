...
def get_place_amenities(place_id):
    """
    file: documentation/place_amenity/get_places_amenities.yml
    """
...
def delete_place_amenity(place_id, amenity_id):
    """
    file: documentation/place_amenity/delete_place_amenities.yml
    """
    place = storage.get(Place, place_id)
...
def post_place_amenity(place_id, amenity_id):
    """
    file: documentation/place_amenity/post_place_amenities.yml
    """
    place = storage.get(Place, place_id)
