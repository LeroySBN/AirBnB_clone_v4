...
def get_cities(state_id):
    """
    file: documentation/city/cities_by_state.yml
    """
    list_cities = []
...
def get_city(city_id):
    """
    file: documentation/city/get_city.yml
    """
...
def delete_city(city_id):
    """
    file: documentation/city/delete_city.yml
    """
    city = storage.get(City, city_id)
...
def post_city(state_id):
    """
    file: documentation/city/post_city.yml
    """
    state = storage.get(State, state_id)
    if not state:
        abort(404)
...
def put_city(city_id):
    """
    file: documentation/city/put_city.yml
    """
    city = storage.get(City, city_id)
    if not city:
        abort(404)
