...
def get_amenities():
    """
    file: documentation/amenity/all_amenities.yml
    """
...
def get_amenity(amenity_id):
    """
    file: documentation/amenity/get_amenity.yml
    """
...
def delete_amenity(amenity_id):
    """
    file: documentation/amenity/delete_amenity.yml
    """
...
def post_amenity():
    """
    file: documentation/amenity/post_amenity.yml
    """
...
def put_amenity(amenity_id):
    """
    file: documentation/amenity/put_amenity.yml
    """
    if not request.get_json():
        abort(400, description="Not a JSON")
